...
architecture behav of MatchEngineTopL3 is 
    ...
    signal grp_MatchEngine_3_0_s_fu_332_ap_start : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_ap_done : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_ap_idle : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_ap_ready : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_bx_o_V : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_bx_o_V_ap_vld : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_ce0 : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_ce0 : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_ce0 : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_we0 : STD_LOGIC;
    signal grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_d0 : STD_LOGIC_VECTOR (13 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_ap_return_0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_ap_return_1 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_MatchEngine_3_0_s_fu_332_ap_start_reg : STD_LOGIC := '0';
    ...
    component MatchEngine_3_0_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_MatchEngine_3_0_s_fu_332 : component MatchEngine_3_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_MatchEngine_3_0_s_fu_332_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_MatchEngine_3_0_s_fu_332_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_MatchEngine_3_0_s_fu_332_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_MatchEngine_3_0_s_fu_332_ap_ready = ap_const_logic_1)) then 
                    grp_MatchEngine_3_0_s_fu_332_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, bx_o_V_1_ack_in, grp_MatchEngine_3_0_s_fu_332_ap_done, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_MatchEngine_3_0_s_fu_332_ap_done = ap_const_logic_1))) then
    ...
    bx_o_V_1_vld_in <= grp_MatchEngine_3_0_s_fu_332_bx_o_V_ap_vld;
    bx_o_V_ap_vld <= bx_o_V_1_vld_reg;
    grp_MatchEngine_3_0_s_fu_332_ap_start <= grp_MatchEngine_3_0_s_fu_332_ap_start_reg;
    inprojdata_dataarray_data_V_address0 <= grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_address0;
    inprojdata_dataarray_data_V_ce0 <= grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_ce0;
    instubdata_dataarray_data_V_address0 <= grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_address0;
    instubdata_dataarray_data_V_ce0 <= grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_ce0;
    ...
    outcandmatch_dataarray_data_V_d0 <= grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_d0;
    outcandmatch_dataarray_data_V_we0 <= grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_we0;
    outcandmatch_nentries_0_V <= grp_MatchEngine_3_0_s_fu_332_ap_return_0;

    outcandmatch_nentries_0_V_ap_vld_assign_proc : process(grp_MatchEngine_3_0_s_fu_332_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_MatchEngine_3_0_s_fu_332_ap_done = ap_const_logic_1))) then 
    ...
    outcandmatch_nentries_1_V <= grp_MatchEngine_3_0_s_fu_332_ap_return_1;

    outcandmatch_nentries_1_V_ap_vld_assign_proc : process(grp_MatchEngine_3_0_s_fu_332_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_MatchEngine_3_0_s_fu_332_ap_done = ap_const_logic_1))) then 
