...
reg    bx_o_V_1_ack_in;
wire    grp_MatchEngine_3_0_s_fu_332_ap_start;
wire    grp_MatchEngine_3_0_s_fu_332_ap_done;
wire    grp_MatchEngine_3_0_s_fu_332_ap_idle;
wire    grp_MatchEngine_3_0_s_fu_332_ap_ready;
wire   [2:0] grp_MatchEngine_3_0_s_fu_332_bx_o_V;
wire    grp_MatchEngine_3_0_s_fu_332_bx_o_V_ap_vld;
wire   [8:0] grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_address0;
wire    grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_ce0;
wire   [7:0] grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_address0;
wire    grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_ce0;
wire   [7:0] grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_address0;
wire    grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_ce0;
wire    grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_we0;
wire   [13:0] grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_d0;
wire   [7:0] grp_MatchEngine_3_0_s_fu_332_ap_return_0;
wire   [7:0] grp_MatchEngine_3_0_s_fu_332_ap_return_1;
reg    grp_MatchEngine_3_0_s_fu_332_ap_start_reg;
...
#0 grp_MatchEngine_3_0_s_fu_332_ap_start_reg = 1'b0;
end

MatchEngine_3_0_s grp_MatchEngine_3_0_s_fu_332(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_MatchEngine_3_0_s_fu_332_ap_start),
    .ap_done(grp_MatchEngine_3_0_s_fu_332_ap_done),
    .ap_idle(grp_MatchEngine_3_0_s_fu_332_ap_idle),
    .ap_ready(grp_MatchEngine_3_0_s_fu_332_ap_ready),
    .bx_V(bx_V),
    .bx_o_V(grp_MatchEngine_3_0_s_fu_332_bx_o_V),
    .bx_o_V_ap_vld(grp_MatchEngine_3_0_s_fu_332_bx_o_V_ap_vld),
    .instubdata_dataarray_data_V_address0(grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_address0),
    .instubdata_dataarray_data_V_ce0(grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_ce0),
    ...
    .inprojdata_dataarray_data_V_address0(grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_address0),
    .inprojdata_dataarray_data_V_ce0(grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_ce0),
    ...
    .outcandmatch_dataarray_data_V_address0(grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_address0),
    .outcandmatch_dataarray_data_V_ce0(grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_ce0),
    .outcandmatch_dataarray_data_V_we0(grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_we0),
    .outcandmatch_dataarray_data_V_d0(grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_d0),
    .ap_return_0(grp_MatchEngine_3_0_s_fu_332_ap_return_0),
    .ap_return_1(grp_MatchEngine_3_0_s_fu_332_ap_return_1)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_MatchEngine_3_0_s_fu_332_ap_start_reg <= 1'b0;
    end else begin
        if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_MatchEngine_3_0_s_fu_332_ap_start_reg <= 1'b1;
        end else if ((grp_MatchEngine_3_0_s_fu_332_ap_ready == 1'b1)) begin
            grp_MatchEngine_3_0_s_fu_332_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((~((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) & (bx_o_V_1_vld_reg == 1'b0) & (bx_o_V_1_vld_in == 1'b1)) | (~((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) & (1'b1 == 1'b1) & (bx_o_V_1_vld_in == 1'b1) & (bx_o_V_1_vld_reg == 1'b1)))) begin
        bx_o_V_1_data_reg <= grp_MatchEngine_3_0_s_fu_332_bx_o_V;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (grp_MatchEngine_3_0_s_fu_332_ap_done == 1'b1))) begin
...
assign bx_o_V_1_vld_in = grp_MatchEngine_3_0_s_fu_332_bx_o_V_ap_vld;

assign bx_o_V_ap_vld = bx_o_V_1_vld_reg;

assign grp_MatchEngine_3_0_s_fu_332_ap_start = grp_MatchEngine_3_0_s_fu_332_ap_start_reg;

assign inprojdata_dataarray_data_V_address0 = grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_address0;

assign inprojdata_dataarray_data_V_ce0 = grp_MatchEngine_3_0_s_fu_332_inprojdata_dataarray_data_V_ce0;

assign instubdata_dataarray_data_V_address0 = grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_address0;

assign instubdata_dataarray_data_V_ce0 = grp_MatchEngine_3_0_s_fu_332_instubdata_dataarray_data_V_ce0;

assign outcandmatch_dataarray_data_V_address0 = grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_address0;

assign outcandmatch_dataarray_data_V_ce0 = grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_ce0;

assign outcandmatch_dataarray_data_V_d0 = grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_d0;

assign outcandmatch_dataarray_data_V_we0 = grp_MatchEngine_3_0_s_fu_332_outcandmatch_dataarray_data_V_we0;

assign outcandmatch_nentries_0_V = grp_MatchEngine_3_0_s_fu_332_ap_return_0;

assign outcandmatch_nentries_1_V = grp_MatchEngine_3_0_s_fu_332_ap_return_1;

endmodule //MatchEngineTopL3
