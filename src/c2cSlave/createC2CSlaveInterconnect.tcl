...
set_property CONFIG.C_REFCLK_FREQUENCY   {312.5}	      [get_bd_cells ${C2C_PHY}]
...
[AXI_PL_DEV_CONNECT MYVREG1        ${AXI_INTERCONNECT_NAME} ${AXI_MASTER_CLK} ${AXI_MASTER_RSTN} 50000000 0x83D41000 4K]
